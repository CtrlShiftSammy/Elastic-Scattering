...
input_file = open("Iteration Final/elastic.in", "r")
...
def pot(r):
    ...
    if r < rmod:
        ...
        v = zasy / r
    return v
#data_file = open("Iteration Final/density_n+.txt", "r")
#data_file = open("Iteration Final/density_n2+.txt", "r")
#data_file = open("Iteration Final/density_n3+.txt", "r")
#data_file = open("Iteration Final/density_na+.txt", "r")
#data_file = open("Iteration Final/density_na+.txt", "r")
#data_file = open("Iteration Final/density_na+.txt", "r")
#data_file = open("Iteration Final/density_na+.txt", "r")
#data_file = open("Iteration Final/density_na+.txt", "r")
#data_file = open("Iteration Final/density_na+.txt", "r")
#data_file = open("Iteration Final/density_xe2+.dat", "r")
#data_file = open("Iteration Final/density_xe3+.txt", "r")
#data_file = open("Iteration Final/density_xe4+.txt", "r")
#data_file = open("Iteration Final/density_xe5+.txt", "r")
data_file = open("Iteration Final/density_xe6+.txt", "r")
#data_file = open("Iteration Final/density_xe8+.txt", "r")
#data_file = open("Iteration Final/density_ar+.txt", "r")
#data_file = open("Iteration Final/density_ar2+.txt", "r")
#data_file = open("Iteration Final/density_ar3+.txt", "r")
#data_file = open("Iteration Final/density_ar7+.txt", "r")
#data_file = open("Iteration Final/density_ar8+.txt", "r")

listA = [[float(num) for num in line.split(' ')] for line in data_file]
data = np.array(listA)
data_file.seek(0)
data_lines = data.shape[0]
...
hcon = 4.0*pi/p1/p1
tcs=0.0
phase_file = open("Iteration Final/Phase shifts.txt", "w")
for i in range(lmin1, lmx + 1, lspc):
    l = i - 1
    logder = z11[i] / p1
    fhyp = f[l]
...
phase_file.close()
crosssection_file = open("Iteration Final/Cross_sections.txt", "w")
for theta in range(0, 180):
    ...
    dcs = abs(cf)**2
    crosssection_file.write(str(theta) + "   " +  str(dcs) + "   " +  str(ruther**2) + "   " + str(ruthzm**2) + "\n") # * math.pow((5.291177210903 * math.pow(10, -11)), 2) * math.pow(10, 16) * math.pow(10, 4)
crosssection_file.close()

potential_file = open("Iteration Final/potential_file.txt", "w")
for i in range(0, data_lines):
    potential_file.write(str(data[i, 0]) + "   " + str(data[i, 4]) + "   " + str(data[i, 7]) + "   " + "\n")
potential_file.close()
potential_file = open("Iteration Final/data_file.txt", "w")
for i in range(0, data_lines):
    potential_file.write(str(data[i, 0]) + "   " + str(data[i, 1]) + "   " + str(data[i, 2]) + "   " + str(data[i, 3]) + "   " + str(data[i, 4]) + "   " + str(data[i, 5]) + "   " + str(data[i, 6]) + "   " + str(data[i, 7]) + "   " + "\n")
potential_file.close()
