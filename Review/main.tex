...
%------------------------------------------------------------	
\newcommand{\Title}{Differential Cross Section Measurements for Elastic Scattering of Electrons from Heavy Atoms and Ions} 	% Manuscript title goes here.
\newcommand{\shortTitle}{Short-title} 		        % Short title for header goes here, less than 60 characters.
\newcommand{\Author}{Bhattacharjee et al.\xspace}    	% First author goes here.

%------------------------------------------------------------
%  Author details go here 
%------------------------------------------------------------	
\author[{{\affiliation{1}}}] 				% affiliation number
{\orcidaffil{0000-0001-7437-3916}~			% orcid number
Kaustav Bhattacharjee 				% first author
\Email{kaustav2082@gmail.com}} 		        	% corresponding author email
\author[{{\affiliation{1}}}] 				% affiliation number
{\orcidaffil{0000.0000.0000.0000}~			% orcid number
Adityan Santhakumar} 					        	% second author
