...
input_file = open("Iteration 09/elastic.in", "r")
...
def pot(r):
    ...
    return v
#data_lines = 182
#data_file = open("Iteration 09/density_xe+2.dat", "r")
data_lines = 787720
data_file = open("Iteration 09/density_n+2_smooth.dat", "r")
...
hcon = 4.0*pi/p1/p1
tcs=0.0
phase_file = open("Iteration 09/Phase shifts.txt", "w")
for i in range(lmin1, lmx + 1, lspc):
    l = i - 1
    logder = z11[i] / p1
    fhyp = f[l]
...
phase_file.close()
crosssection_file = open("Iteration 09/Cross sections.txt", "w")
...
potential_file = open("Iteration 09/potential_file.txt", "w")
